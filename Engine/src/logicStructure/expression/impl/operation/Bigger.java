...
public class Bigger extends BinaryExpression implements Funcion {

    public Bigger(Expression left, Expression right) {
        super(OperationName.BIGGER, left, right);
    }

    public Bigger(){
        super(OperationName.BIGGER);
    }
...
//            } //need?
    ...
    public String getOperationName() {
        return OperationName.BIGGER.toString();
    }

    @Override
    public OperationName getOperationType() {
        return OperationName.BIGGER;
    }
