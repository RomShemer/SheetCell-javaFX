...
public class And extends BinaryExpression implements Funcion {
    public And(Expression left, Expression right) {
        super(OperationName.AND, left, right);
    }
...
//            } //need?
    ...
    public String getOperationName() {
        return OperationName.AND.toString();
    }

    @Override
    public OperationName getOperationType() {
        return OperationName.AND;
    }
