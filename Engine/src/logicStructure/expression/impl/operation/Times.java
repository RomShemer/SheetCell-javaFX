...
public class Times extends BinaryExpression implements Funcion {

    public Times(Expression left, Expression right) {
        super(OperationName.TIMES, left, right);
    }

    public Times(){
        super(OperationName.TIMES);
    }
    ...
    public String getOperationName(){
        return OperationName.TIMES.toString();
    }

    @Override
    public OperationName getOperationType(){
        return OperationName.TIMES;
    }
